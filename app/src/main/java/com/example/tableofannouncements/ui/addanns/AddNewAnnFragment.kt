...
import com.example.tableofannouncements.ui.addanns.dialogs.DialogSpinnerHelper
import com.example.tableofannouncements.ui.addanns.adapters.ImageVpAdapter
import com.example.tableofannouncements.ui.addanns.dialogs.SuccessDialog
import com.example.tableofannouncements.ui.addanns.helpers.MainValidatorHelper
import com.example.tableofannouncements.utils.SharedPreferences
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class AddNewAnnFragment : BaseGoogleAdsFragment() {
    private var _binding: FragmentAddNewAdsBinding? = null
    val binding get() = _binding!!

    private val viewModel: AddNewAnnViewModel by viewModels()
    ...
    override fun onClose() {
        ...
        if (mainValidatorHelper.isAllValid()) {
            ...
            viewModel.publishAnn(createdAnnouncement)
